...
#Evaluar que el number1 sea mayor a numero2 y  numero1 numero3
print(f"{number1} > {number2} Y {number1} > {number3} = {number1 > number2 and number1 > number3}")
#evaluar que el number1 sea mayor a numero2 o  numero1 numero3

print(f"{number1} > {number3}) O ({number2} < {number3} = {number1 > number3 or number3 > number2}")

#Negar que numero 1 sea mayor que numero 2
